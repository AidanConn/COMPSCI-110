...
//Instructor: Dr. Omar
//
//Purpose: This programs simulates dealing cards using loops | Revised by adding more methods
//**************************

import java.util.Scanner;

public class DealCards2ATC {
    int dealtCards = 0;
    public static void main(String[] args) {
        ...
        while (true){
            System.out.printf("The next card is %s of %s \n", getFace(),  getSuit());
